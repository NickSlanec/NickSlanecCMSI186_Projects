 ...
 *  @version 1.1.0  2019-02-11  Nick Slanec   Starting Assignment
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
public class DiceSet {
   ...
   public int sum() {
    int sumCounter = 0;
      for (int i = 0; i < this.count; i ++){
        sumCounter = sumCounter + ds[i].getValue();
      }
    return sumCounter;
   }
   ...
   */
   public String toString() {
     String result = "";
     for ( int i = 0; i < this.count; i++){
       result = result + ds[i].toString(); // It'll return the toString of each die in the array
     }
      return result;
   }
